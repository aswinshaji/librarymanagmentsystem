...
public class Main {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (username.equals("")) {
                    ...
                    try {
                        ...
                        PreparedStatement pstat = connection.prepareStatement("SELECT * FROM USERS WHERE USERNAME=? AND PASSWORD=?", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    public static Connection connect() {
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/mysql?user=root&password=1995");
            return con;
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public static void admin_menu() {
        ...
        issue_book.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                l4 = new JLabel("Issued Date(MM-DD-YYYY)");
        ...
        return_book.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                l4=new JLabel("Return Date(MM-DD-YYYY)");
                ...
                create_but.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try{
                            ...
                            try {
                                Date date_1= new SimpleDateFormat("MM-DD-YYYY").parse(date1);
                                Date date_2= new SimpleDateFormat("MM-DD-YYYY").parse(date2);
